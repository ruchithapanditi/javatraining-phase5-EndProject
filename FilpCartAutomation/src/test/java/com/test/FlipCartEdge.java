...
public class FlipCartEdge {
	WebDriver driver;
  
  @BeforeClass
  public void beforeClass() {
	  System.setProperty("webdriver.edge.driver", "C:\\Users\\Admin\\OneDrive\\Desktop\\Java Training\\Phase5Workspace\\TestNG\\Edge driver\\msedgedriver.exe");
  ...
  js.executeScript("window.scrollBy(2,document.body.scrollHeight)");
  ...
  public void loadImage() throws InterruptedException {
	  String url ="https://www.flipkart.com/apple-iphone-13-blue-256-gb/p/itmd68a015aa1e39?pid=MOBG6VF566ZTUVFR&lid=LSTMOBG6VF566ZTUVFR2RQLVU&marketplace=FLIPKART&q=iPhone+13&store=tyy%2F4io&srno=s_1_8&otrack&otracker1=search&fm=organic&iid=1c0c7402-fe4f-4f45-9aa8-cc59dffe8503.MOBG6VF566ZTUVFR.SEARCH&ppt=hp&ppn=homepage&ssid=i4t60bsv4g0000001665375424769&qH=c3d519be0191fbf8";
	  driver.get(url);
	  Thread.sleep(3000);
